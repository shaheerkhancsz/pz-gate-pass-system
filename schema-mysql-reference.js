...
exports.notifications = exports.companySettings = exports.documents = exports.userActivityLogs = exports.drivers = exports.customers = exports.gatePasses = void 0;
// Gate Pass model
exports.gatePasses = mysqlTable("gate_passes", {
...
// Customer model
exports.customers = mysqlTable("customers", {
    id: int("id").primaryKey().autoincrement(),
...
// Driver model
exports.drivers = mysqlTable("drivers", {
    id: int("id").primaryKey().autoincrement(),
    name: varchar("name", { length: 255 }).notNull(),
...
exports.userActivityLogs = mysqlTable("user_activity_logs", {
    id: int("id").primaryKey().autoincrement(),
    userId: int("user_id").references(function () { return users.id; }, { onDelete: "set null" }),
...
exports.documents = mysqlTable("documents", {
    id: int("id").primaryKey().autoincrement(),
    ...
    uploadedBy: int("uploaded_by").references(function () { return users.id; }, { onDelete: "set null" }),
    uploadedByEmail: varchar("uploaded_by_email", { length: 255 }).notNull(),
    createdAt: datetime("created_at").notNull(),
});
// Company settings table to store configurations
exports.companySettings = mysqlTable("company_settings", {
    id: int("id").primaryKey().autoincrement(),
...
exports.notifications = mysqlTable("notifications", {
    id: int("id").primaryKey().autoincrement(),
    userId: int("user_id").references(function () { return users.id; }, { onDelete: "cascade" }),
